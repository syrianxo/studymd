...
// components/ManageLectureCard.tsx
// The manage-mode-only card used inside ManageMode.tsx.
// Features: drag handle (useSortable), kebab menu with course/color/tags/hide/archive.
// Does NOT have: expand panel, study mode buttons, progress bars, lightbox.
